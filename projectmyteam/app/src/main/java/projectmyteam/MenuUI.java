...
public class MenuUI {
    ...
    public MenuUI(Stage primaryStage) {
        ...
        root.setStyle("-fx-padding: 5;" + "-fx-background-color: linear-gradient(to bottom, rgb(255, 222, 11),rgb(0, 208, 59));");
        root.requestFocus();
        ...
        foodListView.setStyle("-fx-background-color: white; -fx-border-color: white;");
